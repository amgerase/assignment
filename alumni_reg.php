...
<body>
    ...
    <form method="post" action="alumni_reg.php">
        ...
        <div class="inputs">
            <label for="fullname">Names</label><br>
            <input type="text" name="fullname" value="" placeholder="format: Jane J Doe">
        </div>
        <div class="inputs">
        ...
        <div class="inputs">
            <label for="fullname">Repeat password</label><br>
            <input type="pass2" name="pass2">
        </div>
        <div class="buttons">

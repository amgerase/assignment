...
<body>
    ...
    <form method="post" action="registry.php">
        ...
        <div class="inputs">
            ...
            <input type="text" name="mname" value="" placeholder="format: Jane">
        </div>
        <div class="inputs">
            <label for="sname">surname</label><br>
            <input type="text" name="sname" placeholder="format: jane">
        </div>
        <div class="inputs">
            <label for="uname">username</label><br>
            <input type="text" name="uname" value="" placeholder="format: janedoe">
        </div>
        <div class="inputs">
            <label for="email">e-mail</label><br>
            <input type="email" name="email" value="" placeholder="format: abc@xy.z">
        </div>
        <div class="inputs">
            <label for="phoneno">phone#</label><br>
            <input type="text" name="phoneno" value="" placeholder="format: 0755226465">
        </div>
        <div class="inputs">
...
if(isset($_POST["reg_alumni"]) && ($_POST[fname] && $_POST[mname] && $_POST[sname] && $_POST[uname] && $_POST[email] && $_POST[phoneno] && $_POST[socmedia] || $_POST[password_1] || $_POST[bdate])!=0) {
